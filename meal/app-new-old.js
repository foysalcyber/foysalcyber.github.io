...
function updateAnnouncementUI() {
  ...
  if (!active) return;
  const unread = sessionStorage.getItem(announcementSeenKey()) !== announcementSignature(state.announcement);
...
function maybeShowAnnouncement() {
  ...
  if (sessionStorage.getItem(announcementSeenKey()) === announcementSignature(state.announcement)) return;
...
function dismissAnnouncement() {
  ...
  if (announcementIsActive()) {
    sessionStorage.setItem(announcementSeenKey(), announcementSignature(state.announcement));
  }
  updateAnnouncementUI();
}
